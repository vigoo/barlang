...
object Play extends App {
  val tokens = Parser.BarlangLexer.parse(Parser.BarlangLexer.tokens,
    """|return "alma"
       |return "korte"
       |return true
       |return false
  ...
  //    """.stripMargin
  //
  //  Parser.BarlangLexer.parse(Parser.BarlangLexer.tokens, gradientSrc) match {
  //    case Parser.BarlangLexer.Success(result, next) =>
  //      println(result)
  //    case fail: Parser.BarlangLexer.NoSuccess =>
  //      println(fail)
  //  }
  //
}
